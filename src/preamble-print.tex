...
\documentclass[11pt,twoside,openright,paper=a4]{book}
...
% don't color links for print
\usepackage[hidelinks]{hyperref}  % makes cross references and URLs clickable
...
% use grayscale for code
\definecolor{SchemeBlue}    {HTML} {686868}
\definecolor{SchemeGreen}   {HTML} {5F5F5F}
\definecolor{SchemeBrown}   {HTML} {797979}
\definecolor{SchemeRed}     {HTML} {676767}
\definecolor{SchemeViolet}  {HTML} {585858}
...
\renewcommand{\LettrineFontHook}{\rmfamily\mdseries\color{DropCapGray}}
...
\titleformat{\chapter}[display]
  ...
  {\filright \color{ChapterGray}\sffamily\mdseries
...
{\color{DropCapGray}\thesection}{0.8em}{}

\titleformat{\subsection}
{\color{SchemeDark}\normalfont\large\sffamily\bfseries}
{\color{DropCapGray}\thesubsection}{0.8em}{}

\titleformat{\subsubsection}
{\color{black}\normalfont\normalsize\sffamily\bfseries}
{\color{DropCapGray}\thesubsubsection}{0.8em}{}
...
\includepdf[scale=0.92]{coverpage-print.pdf}
